...
parser.add_argument('--n_query',    type=int,   default=15,         metavar='NQUERY',
                    help="nquery")
parser.add_argument('--n_epochs',   type=int,   default=10,       metavar='NEPOCHS',
                    help="nepochs")
...
parser.add_argument('--gamma',      type=float, default=0.5,        metavar='GAMMA',
                    help="decay rate")
parser.add_argument('--patience',   type=int,   default=100,        metavar='PATIENCE',
...
def main():
    ...
    if dataset=='mini':
        ...
        loader_train = dataset_omni(n_examples, n_episodes, 'train', args_data)
        loader_val   = dataset_omni(n_examples, n_episodes, 'val', args_data)
    ...
    model = models.Prototypical(args)
    model.cuda(0)
